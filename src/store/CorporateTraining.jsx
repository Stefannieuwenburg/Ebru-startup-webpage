...
const CorporateTraining = () => {
    return (
        <>
            <section id="corporatetraining" className="bg-[#f0eae2] min-h-screen pt-12 pb-20 scroll-mt-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-[#3b3a2e] mb-6">
                                Empower your team with embodiment-based trainings designed to build emotional
                                intelligence, resilience, and presence in the workplace. Through somatic awareness,
                                breathwork, and conscious movement, these sessions help teams manage stress, improve
                                focus, and foster authentic leadership in fast-paced environments.
                            </p>
                            ...
                            <p className="text-lg text-[#3b3a2e] mb-8 mt-4">
                                These trainings are adaptable for team offsites, leadership retreats, and can be offered
                                globally, both in-person and online. Let’s co-create a more conscious, connected, and
                                thriving workplace — one breath, one body, one leader at a time.
                            </p>
                            <Link
                                to="/contact"
