    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by breathandbodymovement </p>
    </div>
</section>
