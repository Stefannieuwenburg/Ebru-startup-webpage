    ...
    return (
        <div id="about" className="relative bg-[#f0eae2] min-h-screen scroll-mt-16">
            <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
                <img src="/assets/decorative-brush.svg" alt="" className="w-full h-full object-cover" />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-12 pb-16">
                    ...
                    <div className="text-center lg:text-left mb-6">
                        ...
                        <div className="text-lg italic text-[#3b3a2e] mb-5 mt-4 leading-relaxed">
                            ...
                            <p>
                                My mission is to create a world where we feel more, not less; so we can live, lead, and
                                love with truth, joy, and presence.
                            </p>
                        </div>
