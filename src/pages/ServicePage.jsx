      ...
      <section className="bg-[ #f5f3ef] w-full min-h-screen flex items-center justify-center">
        <div className="max-w-7xl w-full h-full px-4 sm:px-6 flex flex-col justify-center items-center">
          <div className="text-center mb-12 mt-10">
            <h2
              className="text-4xl font-bold text-[#3b3a2e] mb-4"
              style={{
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-start p-6 bg-gradient-to-b from-black/60 via-black/30 to-black/60">
                  ...
                  <Link
                    to={service.link}
                    className="bg-[#f7f7f7] text-[#3b3a2e] px-5 py-2 rounded-3xl font-semibold hover:bg-[#e5e5e5] hover:shadow-xl hover:scale-105 transition-all duration-300 ease-in-out"
                  >
                    Learn More
                  </Link>
                </div>
