      ...
      <section className="bg-[ #f5f3ef] min-h-screen pt-12 pb-20 scroll-mt-16 w-full flex items-center justify-center">
        <div className="max-w-7xl w-full h-full px-4 sm:px-6 flex flex-col justify-center items-center">
          <div className="text-center mb-12 mt-10">
            <h2
              className=" font-playfair leading-relaxed text-4xl italic text-[#3b3a2e] mb-4"
            >
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-start p-6 bg-gradient-to-b from-black/60 via-black/30 to-black/60">
                  <h3
                    className="fonts-playfair leading-relaxed text-2xl font-bold text-white mb-2"
                  >
                    {service.title}
                  </h3>
                  <p
                    className="fonts-playfair leading-relaxed text-white font-medium text-lg mb-4"
                  >
                    {service.description}
                  </p>
                  <Link
                    to={service.link}
                    className="bg-[#f7f7f7] text-[#3b3a2e] px-5 py-2 rounded-3xl hover:bg-[#e5e5e5] hover:shadow-xl hover:scale-105 transition-all duration-300 ease-in-out"
                  >
                    Learn More
                  </Link>
                </div>
