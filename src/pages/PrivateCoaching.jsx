...
const PrivateCoaching = () => {
    ...
    const extendedText = (
        <div className="mt-4 space-y-4 text-[#3b3a2e] text-base">
            <div>
        ...
        <section id="privatecoaching" className="bg-[#f0eae2] min-h-screen py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-[#3b3a2e] mb-2">1-1 Coaching</h2>

                        <p className="text-base text-[#3b3a2e] mb-2">
                        ...
                        <h3 className="text-lg font-semibold text-[#3b3a2e] mb-2">In our work together, you’ll:</h3>
                        <ul className="list-none text-[#3b3a2e] mb-2 space-y-2">
                        ...
                        <h3 className="text-lg font-semibold text-[#3b3a2e] mb-2">Coaching Journeys</h3>
                        {!showMore && (
                            <button
                                onClick={toggleText}
                                className="text-[#3b3a2e] underline hover:text-[#2d2c22] transition"
                            >
                                Read More
                            </button>
                        )}
                        {showMore && (
                            <>
                                ...
                                <button
                                    onClick={toggleText}
                                    className="mt-4 text-[#3b3a2e] underline hover:text-[#2d2c22] transition"
                                >
                                    Read Less
                                </button>
                            </>
                        ...
                        <h3 className="text-lg font-semibold text-[#3b3a2e] mb-2 mt-6">1:1 Somatic Movement Session</h3>
                        <p className="text-base text-[#3b3a2e] mb-2">
                        ...
                        <ul className="text-base text-[#3b3a2e] mb-2 space-y-2">
                        ...
                        <h3 className="text-lg font-semibold text-[#3b3a2e] mb-2">1:1 Breathwork Session</h3>
                        <p className="text-base text-[#3b3a2e] mb-2">
