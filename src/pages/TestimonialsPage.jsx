          ...
          {testimonials.map((t, index) => (
            <div key={index} className="p-4">
              <div className="h-full flex flex-col items-center justify-center bg-white rounded-lg p-6 shadow-md">
                ...
                <p className="text-gray-900 font-medium tracking-wider text-sm text-center">{t.text}</p>
                <span className="inline-block h-1 w-10 rounded bg-[#3b3a2e] mt-2 mb-2"></span>
                <h2 className="text-gray-900 font-medium tracking-wider text-sm text-center">{t.name}</h2>
                <h2 className="text-gray-900 font-medium tracking-wider text-sm text-center">{t.role}</h2>
                <h2 className="text-gray-900 font-medium tracking-wider text-sm text-center">{t.county}</h2>
              </div>
            </div>
          ))}
        </Slider>
